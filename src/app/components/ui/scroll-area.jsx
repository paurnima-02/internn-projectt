...
function ScrollArea({
  ...
  return /*#__PURE__*/_jsxDEV(ScrollAreaPrimitive.Root, {
    ...
    ...props,
    children: [/*#__PURE__*/_jsxDEV(ScrollAreaPrimitive.Viewport, {
      "data-slot": "scroll-area-viewport",
      className: "focus-visible:ring-ring/50 size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1",
      children: children
    }, void 0, false), /*#__PURE__*/_jsxDEV(ScrollBar, {}, void 0, false), /*#__PURE__*/_jsxDEV(ScrollAreaPrimitive.Corner, {}, void 0, false)]
  }, void 0, true);
}
function ScrollBar({
  className,
