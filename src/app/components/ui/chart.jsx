...
function ChartContainer({
  ...
  return /*#__PURE__*/_jsxDEV(ChartContext.Provider, {
    ...
    children: /*#__PURE__*/_jsxDEV("div", {
      ...
      ...props,
      children: [/*#__PURE__*/_jsxDEV(ChartStyle, {
        id: chartId,
        config: config
      }, void 0, false), /*#__PURE__*/_jsxDEV(RechartsPrimitive.ResponsiveContainer, {
        children: children
      }, void 0, false)]
    }, void 0, true)
  }, void 0, false);
...
function ChartTooltipContent({
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [!nestLabel ? tooltipLabel : null, /*#__PURE__*/_jsxDEV("div", {
      ...
      children: payload.map((item, index) => {
        ...
        return /*#__PURE__*/_jsxDEV("div", {
          ...
          children: formatter && item?.value !== undefined && item.name ? formatter(item.value, item.name, item, index, item.payload) : /*#__PURE__*/_jsxDEV(_Fragment, {
            children: [itemConfig?.icon ? /*#__PURE__*/_jsxDEV(itemConfig.icon, {}, void 0, false) : !hideIndicator && /*#__PURE__*/_jsxDEV("div", {
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                className: "grid gap-1.5",
                children: [nestLabel ? tooltipLabel : null, /*#__PURE__*/_jsxDEV("span", {
                  className: "text-muted-foreground",
                  children: itemConfig?.label || item.name
                }, void 0, false)]
              }, void 0, true), item.value && /*#__PURE__*/_jsxDEV("span", {
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: payload.map(item => {
      ...
      return /*#__PURE__*/_jsxDEV("div", {
        ...
        children: [itemConfig?.icon && !hideIcon ? /*#__PURE__*/_jsxDEV(itemConfig.icon, {}, void 0, false) : /*#__PURE__*/_jsxDEV("div", {
          className: "h-2 w-2 shrink-0 rounded-[2px]",
          style: {
            backgroundColor: item.color
          }
        }, void 0, false), itemConfig?.label]
      }, item.value, true);
    })
  }, void 0, false);
}
